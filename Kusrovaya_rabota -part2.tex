...
%Построение графика
\draw [domain=-8:8, help lines,thick,smooth, red] plot ({\x},{sqrt(3))*sin(\x r)+cos(\x r)-cos(2*(\x r)+pi/3))+1});
\node [below] {$0$};
...
\draw [domain=0:2.616, help lines,thick,smooth, red] plot ({\x},{sqrt(3))*sin(\x r)+cos(\x r)-cos((2*\x r)+pi/3))+1});
\node [below] {$0$};
