...
\begin{tikzpicture}[scale=1.4,yscale=0.8] 
...
%Построение графика
\draw [domain=-3.2:2.1, help lines, smooth, yellow] plot ({\x},{(\x-\xa)*(\x-\xb)*(\x-\xc)}) node [right,black] {$f(x)=x^3+3x^2-4x-12$};

%Построение касательной 1 для 1 корня
\draw [domain=-3.3:-2.9, help lines, smooth, black] plot ({\x},{(7.52*\x)+22.816}) node [left,black] {$7.52x+22.816$};
%Построение касательной 1 для 2 корня
\draw [domain=-3.3:-2.8, help lines, smooth, brown] plot ({\x},{(6.23*\x)+18.752}) node [left,brown] {$6.23x+18.752$};
%Построение касательной 1 для 3 корня
\draw [domain=-3.3:-2.69, help lines, smooth, orange] plot ({\x},{(5.12*\x)+15.361}) node [left,orange] {$5.12x+15.361$};
%%%%%%%%%%%%%%%
...
\draw[thin,blue,dashed] (-3.2,0)--(-3.2,-1.4) node [below] {$X_{11}=-3.2$};
\draw[thin,blue,dashed] (-3.1,0)--(-3.1,-0.6) node [below] {$X_{12}=-3.1$};
\draw[thin,blue,dashed] (-3.01,0)--(-3.01,-0.1) node [below] {$X_{13}=-3.01$};
