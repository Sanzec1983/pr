...
({\D/8},{\D/(-8)}) node {${3-AB\overline{CD}}(0)$}%3
({\D/8+\D/(4)},{\D/(-8)}) node {$1-ABC\overline{D}(0)$}%1
({\D/2+\D/(8)},{\D/(-8)}) node {$9-\overline{AD}BC(0)$}%9
({\D-\D/(8))},{\D/(-8)}) node {$11-\overline{ACD}B(0)$}%11

({\D/8},{\D/(-8)+\D/(-4)}) node {$2-AB\overline{C}D(0)$}%2
({\D/8+\D/(4)},{\D/(-8)+\D/(-4)}) node {$0-ABCD(0)$}%0
({\D/2+\D/(8)},{\D/(-8)+\D/(-4)}) node {$8-\overline{A}BCD(1)$}%8
({\D-\D/(8))},{\D/(-8)+\D/(-4)}) node {$10-\overline{AC}BD(1)$}%10

({\D/8},{\D*(-0.5)+\D/(-8)}) node {$6-AD\overline{BC}(1)$}%6
({\D/8+\D/(4)},{\D*(-0.5)+\D/(-8)}) node {$4-ACD\overline{B}(0)$}%4
({\D/2+\D/(8)},{\D*(-0.5)+\D/(-8)}) node {$12-\overline{AB}CD(1)$}%12
({\D-\D/(8))},{\D*(-0.5)+\D/(-8)}) node {$14-\overline{ABC}D(1)$}%14

({\D/8},{-\D+\D/8}) node {$7-A\overline{BCD}(1)$}%7
({\D/8+\D/(4)},{-\D+\D/8}) node {$5-AC\overline{BD}(1)$}%5
({\D/2+\D/(8)},{-\D+\D/8}) node {$13-\overline{ABD}C(1)$}%13
({\D-\D/(8))},{-\D+\D/8}) node {$15-\overline{ABCD}(1)$};%15
